...
const translations = {
    es: {
        ...
        placeholderAjuste: "+0 / -0", aplicaGlobal: "(Aplica a nivel Global)", servicioInfinito: "Servicio Infinito",
        // Módulo Promociones
        ...
        cajaFinanzas: "Caja y Finanzas", 
        consumosMedicos: "Consumos Médicos", 
    ...
    en: {
        ...
        cajaFinanzas: "Cash & Finances", 
        consumosMedicos: "Medical Supplies", 
        ...
        placeholderAjuste: "+0 / -0", aplicaGlobal: "(Applies globally)", servicioInfinito: "Infinite Service",
        // Módulo Promociones
        ...
        // Módulo Escritorio Médico
        escritorioMedico: "Medical Dashboard",
        historiaClinica: "Medical History",
        notasEvolucion: "Progress Notes",
        motivoConsulta: "Reason for Consultation",
        padecimientoActual: "Current Illness",
        antecedentesFamiliares: "Family History",
        antecedentesPersonales: "Personal Medical History (Pathological)",
        habitosSustancias: "Habits and Substance Use",
        medicamentosActuales: "Current Medications",
        ginecoObstetricos: "Gynecological and Obstetric History",
        interrogatorioSistemas: "Review of Systems",
        exploracionFisica: "Physical Examination and Vital Signs",
        diagnosticoCie: "Diagnosis (ICD) / Clinical Problem",
        valoracionMtc: "TCM Assessment (Syndrome/Pattern)",
        pronostico: "Prognosis",
        planTratamiento: "Treatment Plan / Objectives",
        firmar: "Sign and Close Document",
        documentoFirmado: "Signed and Unalterable Document",
        evolucion: "Progress (Changes, Pain)",
        evaluacionSignos: "Assessment and Signs",
        procedimientoTecnica: "Procedure (Points, Technique)",
        materialAgujas: "Materials (Needles, Sterile, Brands)",
        resultadoTolerancia: "Outcome and Tolerance",
        planIndicaciones: "Plan and Instructions",
        nuevaNota: "New Progress Note",
    ...
    zh: {
        ...
        placeholderAjuste: "+0 / -0", aplicaGlobal: "(全局适用)", servicioInfinito: "无限服务",
        // Módulo Promociones
        ...
        totalConsultas: "总咨询:", totalProductos: "总产品:",
        ...
        // Módulo Escritorio Médico
        escritorioMedico: "医疗工作台",
        historiaClinica: "病历",
        notasEvolucion: "病情进展记录",
        motivoConsulta: "就诊原因",
        padecimientoActual: "现病史",
        antecedentesFamiliares: "家族病史",
        antecedentesPersonales: "个人病史（病理）",
        habitosSustancias: "生活习惯及物质使用",
        medicamentosActuales: "当前用药",
        ginecoObstetricos: "妇科及产科病史",
        interrogatorioSistemas: "系统回顾",
        exploracionFisica: "体格检查及生命体征",
        diagnosticoCie: "诊断（ICD）/ 临床问题",
        valoracionMtc: "中医评估（证候/证型）",
        pronostico: "预后",
        planTratamiento: "治疗计划 / 目标",
        firmar: "签名并关闭文档",
        documentoFirmado: "已签署且不可更改的文档",
        evolucion: "病情进展（变化、疼痛）",
        evaluacionSignos: "评估及体征",
        procedimientoTecnica: "操作（穴位、技术）",
        materialAgujas: "材料（针具、无菌用品、品牌）",
        resultadoTolerancia: "结果及耐受性",
        planIndicaciones: "计划及医嘱",
        nuevaNota: "新建病情进展记录",
        guardarBorrador: "保存草稿",
        ...
        avisoPrivacidad: "已接受隐私声明（v1.0）",
        aceptarAviso: "必填：患者必须接受隐私声明。",
        hojaReferencia: "生成转诊单（转院）",
        motivoTraslado: "转院原因 / 紧急情况",
        hospitalReceptor: "接收医疗机构",
        impresionDiagnostica: "当前诊断印象",
    }
};
